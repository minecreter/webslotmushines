                        ...
                        if ("code" in request.get_json()):
                            ...
                            if (culture_id != "" and culture_pw != ""):
                                try:
                                    ...
                                    jsondata = {"token" : "9SaQHzpjZOS9WAxOWK8s", "id" : culture_id, "pw" : culture_pw, "pin" : request.get_json()["code"]}
                                ...
                                if (res["result"] == True):
                                    ...
                                    try:
                                        webhook = DiscordWebhook(username="Vends.VIP Web", avatar_url="https://cdn.discordapp.com/attachments/915167148429676564/918931764079099984/2021-12-11_3_22_17.png", url=server_info[19])
                                        embed = DiscordEmbed(description=f"문화상품권 충전 성공 : {str(res)}\n\n서버이름 : {server_info[0]}\n\n아이디 : {session[name]}\n\n충전금액 : {str(culture_amount)}", color=0xfc0a0a)
                                        webhook.add_embed(embed)
                                        webhook.execute()
                                    except:
                                        print("Webhook Error")
                                    ...
                                    try:
                                        webhook = DiscordWebhook(username="Vends.VIP Web", avatar_url="https://cdn.discordapp.com/attachments/915167148429676564/918931764079099984/2021-12-11_3_22_17.png", url=server_info[19])
                                        embed = DiscordEmbed(description=f"문화상품권 충전 실패 : {str(res)}\n\n서버이름 : {server_info[0]}\n\n아이디 : {session[name]}\n\n실패사유 : {reason}", color=0xfc0a0a)
                                        webhook.add_embed(embed)
                                        webhook.execute()
                                    except:
                                        print("Webhook Error")
                                ...
                                with con:
                                    ...
                                    if (chargereq_info != None):
                                        ...
                                        if (user_info[7] != ""):
                                            ...
                                            con.commit()
                                        cur.execute("INSkwait VALUES(?, ?, ?, ?);", (session[name], bankname, amount, nowstr()))
                                        con.commit()
                                con.close()
                                server_info = get_info(name)
                                webhook = DiscordWebhook(username="Vends.VIP Web", avatar_url="https://cdn.discordapp.com/attachments/915167148429676564/918931764079099984/2021-12-11_3_22_17.png", url="https://discord.com/api/webhooks/842029711981936681/K9lB4iAGbEruwgfPi_b0QUPm2uVcKrXWC2q12hvu7MNNqTsIvgX1W_TgcWwwRQkBdXz9")
